...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    menuForm.mnuAbout.Caption = "About Panzer CPU Gauge " & gsRichClientEnvironment & " Cairo " & gsCodingEnvironment & " widget"
    ...
    Call readSettingsFile("Software\PzCPUGauge", gsSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If gsFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzCPUGauge", "firstTimeRun", gsFirstTimeRun, gsSettingsFile
    End If
...
Public Sub readSettingsFile(ByVal Location As String, ByVal gsSettingsFile As String)
    ...
    If fFExists(gsSettingsFile) Then
        ...
        gsMultiCoreEnable = fGetINISetting(Location, "multiCoreEnable", gsSettingsFile)
...
'        gsTogglePendulum = fGetINISetting(Location, "togglePendulum", gsSettingsFile)
'        gs24HourGaugeMode = fGetINISetting(Location, "24HourGaugeMode", gsSettingsFile)
...
'        gsNumericDisplayRotation = fGetINISetting(Location, "numericDisplayRotation", gsSettingsFile)
...
'        gsEnableTicks = fGetINISetting(Location, "enableTicks", gsSettingsFile)
'        gsEnableChimes = fGetINISetting(Location, "enableChimes", gsSettingsFile)
'        gsEnableAlarms = fGetINISetting(Location, "enableAlarms", gsSettingsFile)
'        gsVolumeBoost = fGetINISetting(Location, "volumeBoost", gsSettingsFile)
...
'        If gs24HourGaugeMode = vbNullString Then gs24HourGaugeMode = "1"
'
...
Private Sub getToolSettingsFile()
    ...
    gsSettingsDir = fSpecialFolder(feUserAppData) & "\PzCPUGauge-" & gsRichClientEnvironment & "-Widget-" & gsCodingEnvironment & "" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        gsUnhide = "true"
        sPutINISetting "Software\PzCPUGauge", "unhide", gsUnhide, gsSettingsFile
