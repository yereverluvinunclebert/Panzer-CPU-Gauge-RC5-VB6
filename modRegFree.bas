...
Option Explicit 'simple "drop-in" regfree-module for RichClient5 (in the IDE it will use the registered version, but as Exe will require a \Bin\-Subfolder with all RichClient5-Dlls)
